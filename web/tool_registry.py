...
def builtin_tools():
    ...
    return [
        ...
        },
        {
            ...
            "calibration_status": "calibrated",
            "interface_doc": "docs/qimen/奇门遁甲HTTP接口文档.md",
            "pages": ["qimen.html"],
        ...
        },
        {
            ...
            "interface_doc": "docs/bazi/八字HTTP接口文档.md",
            "pages": ["bazi.html"],
        ...
        },
        {
            ...
            "calibration_status": "in_progress",
            "interface_doc": "docs/liuyao/六爻HTTP接口文档.md",
            "pages": ["liu-yao.html"],
        ...
        },
        {
            ...
            "interface_doc": "docs/daliuren/大六壬HTTP接口文档.md",
        ...
        },
        {
            ...
            "calibration_status": "pending",
            "interface_doc": "docs/meihua/梅花易数HTTP接口文档.md",
